...
// マテリアルのリスト
Material lightMat(Color(60.0), Color(0.0), DIFFUSE);
Material grayMat(Color(0.0), Color(0.75), DIFFUSE);
Material redMat(Color(0.0), Color(1.0, 0.0, 0.0), DIFFUSE);
Material pinkMat(Color(0.0), Color(0.75, 0.25, 0.25), DIFFUSE);
Material greenMat(Color(0.0), Color(0.0, 0.75, 0.25), DIFFUSE);
Material blueMat(Color(0.0), Color(0.0, 0.25, 0.75), DIFFUSE);
